...
import { RoleLandingPage } from "@/routes/role-landing-page";

export function getTenantRoutes() {
  return [
    <Route key="dashboard" path="/" element={<RoleLandingPage />} />,
    ...
    <Route
      key="staff-visits"
      path="/staff/visits"
      element={<StaffVisitsPage />}
    />,
    <Route
      key="service-verification"
